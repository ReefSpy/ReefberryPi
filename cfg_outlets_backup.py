...
class PageOutlets(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.rdoIntBus = Radiobutton(self.frame_toolbar, text="Internal Bus", variable=self.BusSelection,
                                    image=self.intbusimg, value=0, indicatoron=0, command=self.showIntBus,
                                    compound=TOP)
        self.rdoIntBus.grid(row=0, column=2)
        ...
        self.rdoExtBus = Radiobutton(self.frame_toolbar, text="External Bus", variable=self.BusSelection,
                                    image=self.extbusimg, value=1, indicatoron=0,
                                    compound=TOP)
        self.rdoExtBus.grid(row=0, column=3)
    ...
    def select_controltype(self,control):
        ...
        self.frame_cfg.grid(row=4, column=0)
    ...
    def select_outlet(self, outlet):
        ...
        self.frame_outlet.grid(row=3, column=0, sticky=W)
        ...
        self.frame_cfg = LabelFrame(self, text="Configuration", relief= RAISED)
        #self.frame_cfg.pack(fill=X, side=TOP)
        self.frame_cfg.grid(row=3, column=0)
    ...
    def showIntBus(self):
        print("showIntBus")
        intbus = InternalBus(container, self)
        intbus.grid(row=10, column=0)
...
class InternalBus(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.frame_cfg.grid(row=5, column=0)

        self.btn_outlet1 = Button(text="outlet 1")
        self.btn_outlet1.grid(row=0, column=0)
        self.btn_outlet2 = Button(text="outlet 2")
        self.btn_outlet1.grid(row=1, column=0)
...
class Outlet(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.frame_outlet = LabelFrame(self, text="Outlet", relief= RAISED)
        #self.frame_outlet.pack(fill=X, side=TOP)
        self.frame_outlet.grid(row=0, column=0, sticky=W)
